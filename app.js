...
document.addEventListener('DOMContentLoaded', async () => {
    console.log("Ultimate Hydro Pro v2.7 Booting...");
    try {
        await idb.init(); 
...
// ✨ NEW: CYA CAMERA COMPRESSION ENGINE ✨
...
window.handlePhotoUpload = (e) => {
    ...
    reader.onload = (event) => {
        ...
        img.onload = () => {
            ...
            const dataUrl = canvas.toDataURL('image/jpeg', 0.7); // Compress aggressively to save DB space
            ...
            if(c) {
                ...
                showCustomerBriefing(c.id); // Reload briefing
            }
        };
...
const generateArrearsHtml = (arrData, cId, context, phone) => { 
    ...
    // ✨ NEW: Debt Collector Buttons built inside the Arrears Box ✨
    return `
